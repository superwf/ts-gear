...
import reserved = require('reserved-words')
import { info } from './debugLog'
import { BaseClass, Interface, Mod, StandardDataSource } from './standard'
...
export class CodeGenerator {
  ...
  public setDataSource(dataSource: StandardDataSource) {
...
export class FilesManager {
  ...
  public async regenerate(report?: typeof info) {
    if (report) {
      this.report = report
    }
  ...
  public async generateFiles(files: {}, dir = this.baseDir) {
