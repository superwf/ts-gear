 ...
 * */
exports.fetchSwagger = async (project, tsGearConfigPath) => {
    ...
    if (url.startsWith('http')) {
        ...
        log_1.info(`got swagger spec doc from ${verbose}}`);
        return swaggerSchema;
    }
    const source = path_1.join(tsGearConfigPath, project.source);
