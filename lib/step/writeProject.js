...
const propertyOfHelper_1 = require("../content/propertyOfHelper");
...
exports.writeProject = (project) => {
    ...
    const definitionContent = Object.getOwnPropertyNames(definitionMap)
        ...
        .join(os_1.EOL);
    prettierWrite_1.prettierWrite([warningComment_1.warningComment, definitionContent].join(os_1.EOL), path_1.join(dest, 'definition.ts'));
    ...
    prettierWrite_1.prettierWrite([
        ...
        propertyOfHelper_1.propertyOf,
        requesterResult.import,
        importAllDefinition_1.importAllDefinition(project),
        requesterResult.code,
        requestContent,
    ].join(os_1.EOL), path_1.join(dest, 'request.ts'));
    prettierWrite_1.prettierWrite([warningComment_1.warningComment, projectIndex_1.projectIndex].join(os_1.EOL), path_1.join(dest, 'index.ts'));
};
