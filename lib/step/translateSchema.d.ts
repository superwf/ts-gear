...
import { IWordsMap } from '../interface';
 ...
 * }
 * */
export declare const generateTranslationMap: (originWords: string[], engine: "baidu" | "google") => Promise<IWordsMap>;
 ...
 * */
export declare const translateSchema: (spec: Spec, engineName: "baidu" | "google") => Promise<void>;
